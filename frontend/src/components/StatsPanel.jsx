        ...
        <div className="stat-block">
          ...
          <ResponsiveContainer width="100%" height={54}>
            <BarChart data={teams} layout="vertical" margin={{ left: 0, right: 12, top: 0, bottom: 0 }}>
              ...
              <YAxis type="category" dataKey="team" width={58} tick={{ fill: "var(--text)", fontSize: 10.5 }} axisLine={false} tickLine={false} />
        ...
        <div className="stat-block">
          ...
          <div className="donut-row">
            <ResponsiveContainer width={72} height={72}>
              <PieChart>
                <Pie data={types} dataKey="count" nameKey="type" innerRadius={20} outerRadius={34} paddingAngle={2} strokeWidth={0}>
